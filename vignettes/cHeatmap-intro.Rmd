...
## Introduction
cHeatmap is a wrapper of the excellent [`ComplexHeatmap::Heatmap()`](https://jokergoo.github.io/ComplexHeatmap/reference/Heatmap.html) function with additional functions and more friendly interface for some common tasks in my work, thus called the **c**onvenience __Heatmap__. I highly recommend reading [ComplexHeatmap book](https://jokergoo.github.io/ComplexHeatmap-reference/book/index.html) for more advanced use.
...
Here are the features:   
 ...
 5. Discrete color-value mapping for integer matrix containing few unique values 
...
many cells invisible, such as `nMat1` below.
...
See Reference Manual for details. Note that the upper label of the legend changed to `>6.6`
```{r, fig.keep = 'last', fig.asp = 5/7 }
cHeatmap(mat1,
  name = "value",
  resetOutliers = T,
...
### Integer matrices
If the number of unique values is greater than `intAsDiscreteCutoff`, the color 
